...
- Define tool schemas before implementation
- Keep domain logic deterministic and independently testable
...
- Do not hide a failure behind a friendly final response
...
- Remove the completed item from `docs/TODO.md` if it is listed there
...
- The change security checks in `SECURITY-COMPLIANCE.md` pass
