...
| Production Backup validation | A stopped-writer snapshot was copied off the VPS to the private operator workstation and restored exactly into an absent private destination on 2026-08-12. The workshop owner chose manual backups before and after demonstrations with 30-day-or-teardown retention. Automated scheduling, encrypted remote object storage, geographic redundancy, and a destructive in-place activation drill remain intentionally out of scope for this workshop. | 2026-08-12 |
